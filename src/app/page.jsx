...
import gol3 from '@/images/photos/gol-3.jpg'
// import gol4 from '@/images/photos/gol-4.jpg'
import gol5 from '@/images/photos/gol-5.jpg'
// import gol6 from '@/images/photos/gol-6.jpg'
import gol7 from '@/images/photos/gol-7.jpg'
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[gol2, gol11, sentry, threeWays, unrequited].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
          ...
          >
            <Image
              src={image}
              alt="work sample image of David's art and exploration"
...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* <Image
          src={portraitNoBg}
          alt="David Melsheimer leaning"
          width={200}
          className="absolute top-0 inset-1000"
        /> */}
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Conceptual artist, web developer, and perennial scholar.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm David. I live and create in Indianapolis—a city full of motion and hidden layers, much like my work. Here, I blend art, technology, and philosophy to explore the subtle and mighty forces shaping our world. If you can ring out some truth, the city might just love you back.
          </p>
          <div className="mt-6 flex gap-6">
            {/* <SocialLink href="#" aria-label="Follow on X" icon={XIcon} /> */}
            <SocialLink
              href="https://www.instagram.com/melshtastic/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/melshiD"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/david-melsheimer-72a0a4137/"
